...
<div class="panel admin-panel margin-top" id="add">
  <div class="panel-head"><strong><span class="icon-pencil-square-o">会议室申请 </span> 
	<a href="user/apply_meeting"><span class="icon-pencil-square-o">会议申请 </span></a>
	</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="user/apply_r">    
...
<div class="panel admin-panel">
  <div class="panel-head"><strong class="icon-reorder">申请会议室记录</strong></div>
